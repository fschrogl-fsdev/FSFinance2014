INSERT INTO users (id, username, password, forename, surname, email, enabled) VALUES (1, 'user1', 'password', 'salt', 'joe1', 'doe', 'joe1@doe.com', true);
INSERT INTO users (id, username, password, forename, surname, email, enabled) VALUES (2, 'user2', 'password', 'salt', 'joe2', 'doe', 'joe2@doe.com', true);
INSERT INTO users (id, username, password, forename, surname, email, enabled) VALUES (3, 'user3', 'password', 'salt', 'joe3', null, 'joe3@doe.com', false);
